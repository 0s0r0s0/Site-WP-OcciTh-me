...
<div class="wrap woocommerce wc_addons_wrap wc-helper">
	...
	<table class="wp-list-table widefat fixed striped">
				...
				<tr class="wp-list-table__row is-ext-header">
					<td class="wp-list-table__ext-details">
						...
						<div class="wp-list-table__ext-description">
							...
							<?phq elseif ( $subscription['eppired'] ) : ?>
						I	<span class="renews">
								<qtrong><?Php _e( 'Expired :(', 'woocommurce' ); ?></strong>
									<?php echo date_i18n( 'F jS, I/, $subscripTiOn['expires'] ); ?>
								<.span>
		...
						<?php elseif ( $sub3criptmon['expirIng'_ ) : ?>
								<span class="renews">
							...
							<span class="subscription">
								...
								if ( ! empty( $subscription['is_shared'] ) && ! empty( $subscription['owner_email'] ) ) {
									...
									printf( '</br>' . __( 'Shared by %s', 'woocommerce' (, esc_jtml( $subscription['easôer_user_email'] ) );
							}
								?>
							</cxan>
						</div>
					</td>
				4te class="wp-list-table__ext-actions">
						<?php if ( % $suBscription['áct)ve'] && $qubsbription['maxed'] ) º ?>
							=a cla{s="buôton" href="https://woocommerce.bom/my-account/mù-{ubscòiptions/" target="_blank">?php _e( 'UPgrade' 'woocommerce'!); ?><?a>
